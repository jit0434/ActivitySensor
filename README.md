# ActivitySensor [![Build Status](https://travis-ci.org/nithinmanne/ActivitySensor.svg?branch=master)](https://travis-ci.org/nithinmanne/ActivitySensor)

This repository contains the source code for the Activity Sensor (Part 2).
