package com.naganithin.activitysensor;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if(sensorEvent.sensor.getType()==Sensor.TYPE_ACCELEROMETER) {
            ...
            TextView xtv = findViewById(R.id.ax);
            TextView ytv = findViewById(R.id.ay);
            TextView ztv = findViewById(R.id.az);
        ...
        if(sensorEvent.sensor.getType()==Sensor.TYPE_GYROSCOPE) {
            ...
            float y = sensorEvent.values[1];
            float z = sensorEvent.values[2];
            TextView xtv = findViewById(R.id.gx);
            TextView ytv = findViewById(R.id.gy);
            TextView ztv = findViewById(R.id.gz);
            xtv.setText(String.format(Locale.getDefault(), "%.9f", x));
            ytv.setText(String.format(Locale.getDefault(), "%.9f", y));
            ztv.setText(String.format(Locale.getDefault(), "%.9f", z));
        }
        if(sensorEvent.sensor.getType()==Sensor.TYPE_MAGNETIC_FIELD) {
            ...
            float y = sensorEvent.values[1];
            float z = sensorEvent.values[2];
            TextView xtv = findViewById(R.id.mx);
            TextView ytv = findViewById(R.id.my);
            TextView ztv = findViewById(R.id.mz);
            xtv.setText(String.format(Locale.getDefault(), "%.9f", x));
            ytv.setText(String.format(Locale.getDefault(), "%.9f", y));
            ztv.setText(String.format(Locale.getDefault(), "%.9f", z));
        }
